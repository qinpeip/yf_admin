import { PT_REFUND_AFTER_SALES_STATUS, PT_REFUND_AFTER_SALES_TYPE } from './entities/e-commerce-platform-refund.entity';

export namespace ECommercePlatform {
  interface IGetGoodsListBody {
    page: number;
    pageSize: number;
    isOnsale?: 0 | 1;
    ownerId: string;
  ...
  interface IlogisticsOnlineBody {
    /**
     * 订单号
     */
    orderSn: string;
